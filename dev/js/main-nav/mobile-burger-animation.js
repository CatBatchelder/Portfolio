...
burgerToXTimeline.to("#middle-line",{duration:0.25, alpha:0},"iOSburgerAnimation")
                    // rotate top line 45 degrees and change the color to light pink
                    .to("#top-line",{duration:0.25,rotation:45, y:10, stroke:"#ECC5C4"},"iOSburgerAnimation")
                    // rotate bottom line -45 degrees and change the color to light pink
                    .to("#bottom-line",{duration:0.25,rotation:-45, y:-10, stroke:"#ECC5C4"},"iOSburgerAnimation")
